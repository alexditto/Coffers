<div class="flex flex-1 flex-col overflow-hidden rounded-2xl border border-line bg-surface p-6 shadow-sm sm:p-8">
    ...
    <div class="mt-8 grid flex-1 grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <div class="flex flex-col gap-3 rounded-xl border border-line bg-canvas p-4">
            ...
            <div>
                <div class="text-sm font-bold text-content">Gather your party</div>
                <p class="mt-1 text-xs text-content-muted">Add friends so you always know who's ready to sit down at the table.</p>
            </div>
        </div>
        ...
        <div class="flex flex-col gap-3 rounded-xl border border-line bg-canvas p-4">
            ...
            <div>
                <div class="text-sm font-bold text-content">Create a campaign or build a character</div>
                <p class="mt-1 text-xs text-content-muted">Take the DM's chair and build a campaign, or roll up a character and join the party as a player.</p>
            </div>
        </div>
        ...
        <div class="flex flex-col gap-3 rounded-xl border border-line bg-canvas p-4">
            ...
            <div>
                <div class="text-sm font-bold text-content">Open the shops</div>
                <p class="mt-1 text-xs text-content-muted">DMs stock a shop with loot, then flip it open or closed with one tap.</p>
            </div>
        </div>

        <div class="flex flex-col gap-3 rounded-xl border border-line bg-canvas p-4">
            <div class="flex items-center gap-2">
                <span class="flex size-8 shrink-0 items-center justify-center rounded-full bg-gold-100 text-xs font-bold text-gold-700 dark:bg-gold-900 dark:text-gold-300">4</span>
                <flux:icon.shopping-bag class="size-5 text-gold-600" />
            </div>
            <div>
                <div class="text-sm font-bold text-content">Fill the coffers</div>
                <p class="mt-1 text-xs text-content-muted">Players spend their gold in open shops and watch the loot land in their inventory.</p>
            </div>
        </div>
    </div>
